...
class NewsletterGenCrew:
    ...
    agents_config = "C:/secuqrprograms/original/TheFinal/agents.yaml"
    tasks_config = "C:/secuqrprograms/original/TheFinal/tasks.yaml"
    ...
    def llm(self):
       llm = ChatGoogleGenerativeAI(
        ...
        verbose=True,
        temperature=0.5,
        google_api_key=os.getenv("GOOGLE_API_KEY=")  # Corrected environment variable name
    )
